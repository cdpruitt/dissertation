...
\begin{figure}[tb]
    ...
    {The \tot\ relative difference between deuterium and hydrogen,
        ...
        D$_{2}$O and H$_{2}$O. Data from our measurement are shown in red; the
        data of Abfalterer et al. \cite{Abfalterer1998} are shown in black.}
    \label{DtoH}
\end{figure}
...
\niEight\ \cite{Perey1993} and at only one energy point, 14.2 \mega\electronvolt, for \niFour\

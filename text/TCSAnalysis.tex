...
against the high-precision data sets on natural samples from 
...
\begin{figure}[ht!]
    ...
    \caption[\niEightFour\ neutron \tot\ relative difference]
    {
        ...
        Eq. \ref{SASAbsolute} prediction for the \niEightFour\ neutron \tot\ relative
...
\begin{figure}[ht!]
    ...
    \caption[\snTwelveFour\ neutron \tot\ relative difference]
    {
        ...
        Eq. \ref{SASAbsolute} prediction for the \snTwelveFour\ neutron \tot\ relative

...
\begin{figure}[ht!]
    ...
    \caption[A illustration of the nuclear Ramsauer effect]
    {
        ...
        we used a potential depth $U$ = 42.8 MeV (following Angeli and Csikai's analysis
...
Experimentally, the charge radius of a nucleus can be determined directly
...
distribution, and elastic electron scattering \cite{DeVries} at a variety of

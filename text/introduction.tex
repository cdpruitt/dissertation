...
\begin{sidewaysfigure}
    ...
    {Isotopes are color-coded by the amount of proton \rxn\ data available in the EXFOR nuclear
        ...
        exists thoughout the 8-200 \mega\electronvolt\ range, the isotope
        is colored blue. If no data exists, the isotope is colored red. For
        isotopes with partial coverage in this range, color varies by the degree
...
scattering on stable isotopes can be used (after a Fourier transform) to provide the full nuclear

...
motivations for OMs, stemming from a simple Ramsauer-effect piecture, are
...
models and be introduced to a simpler Ramsauer-like models as well. For example, building
...
analyses have been carried out to investigate these questions
\cite{Mukhopadhyay2011, Anderson1990, Camarda1984}. The most sophisticated
was conducted by Dietrich et al.\cite{Dietrich2003},
where new data on the $^{182,184,186}$W isotope chain
were collected and Ramsauer- and optical-model analyses completed using these data.
...
Ramsauer model are \textit{suppressed} \ref{Dietrich2003_Ramsauer}. Despite the
...
\begin{figure}[ht]
    \includegraphics[width=0.5\textwidth]{figures/Dietrich2003_RamsauerPotential.png}
...
\begin{figure}[ht]
    \includegraphics[width=0.5\textwidth]{figures/Dietrich2003_OhioPotential.png}
    \caption[$^{186}$W-$^{182}$W neutron \tot\ relative difference and
    Ramsauer model predictions]
    {
        $^{186}$W-$^{182}$W neutron \tot\ relative difference and
...
\oSix data from \cite{Leuschner1990}

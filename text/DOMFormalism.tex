...
\begin{equation}
    ...
    -\frac{4m\pi^{2}}{\hbar^{2}}\bra{\boldmath{k}'m'_{s}}|\Sigma(E)|\ket{\boldmath{k}m_{s}}
\end{equation}
...
\begin{eqnarray}
    ...
    \sigma\cdot\boldmath{\hat{n}}\left[\frac{sin\theta}{2k}\sum_{l=1}^{\infty}[e^{2i\delta_{l+}}-e^{2i\delta_{l-}}]P'_{l}(cos\theta)
\end{eqnarray}
\noindent
where $P_{l}
...
\begin{eqnarray}
    e^{2i\delta_{lj}} & \equiv & \bra{k}|\mathcal{S}_{lj}(E)|\ket{k}
    & = & 1 - 2\pi i \left(\frac{mk}{\hbar^{2}}\right) \bra{k|\Sigma_{lj}(E)|\ket{j}
\end{eqnarray}
\noindent

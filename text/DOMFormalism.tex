...
\begin{figure}[tb]
    ...
    {
        A subset of diagrams from the first few orders of the 
...
introduce a handful of asymmetry-dependent additional terms, described after the symmetric 
potential form is presented. All calculations are performed non-relativistically
...
With these 4 additional asymmetric imaginary terms, the total number of
free parameters used for
fitting asymmetric nuclei in the present work comes to 34: 11 real, 23 imaginary.
...
\begin{itemize}
    ...
    \item understanding of what the value function is (i.e., the function being
        minimized/maximized) and whether certain experimental data are being
...
experimental data part science, part art: fits should deviate as little as possible from the 
...
enough'' to stop fitting. In addition, for an extrapolation from a
...
countless optical model analyses over the last century, the Woods-Saxon radius
parameters $\boldmath{r_{0}}$ and diffuseness parameters $\boldmath{a}$
were expected to be 1.1-1.2
\femto\meter\ and 0.6 \femto\meter, respectively. As non-local behavior is at
least partially associated with Pauli exclusion principle arguments, our fitted
non-localities $\boldmath{\beta}$
...
nuclei like \oSix\ and even \caForty, it is difficult to cleanly separate the negative-energy 
imaginary surface and imaginary volume terms, and this may not be physically

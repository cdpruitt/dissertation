...
\begin{figure}[tb]
    ...
    \caption[Proton and neutron matter density distributions in \caForty]
    {
        ...
        \caForty, the neutron skin is expected to be slightly negative as a
        consequence of slight reduction of proton density in the core from
        Coulomb repulsion. The neutron skin we extract is significantly smaller
...
(0.42 neutrons) to 
mostly full in \caEight\ (6.84 neutrons).
...
experimental binding energy per nucleon, suggesting that the \niFour\
fit parameters are still significantly underconstrained. Accordingly, the neutron skin
we extract for \niFour\ is expected to be less
reliable but still worth reporting. Compared to \niEight, our fit suggests that much of the extra 
neutron density of \niFour\
adds to the occupation of the $\nu$0\fSeven\ and $\nu$0\fFive\ subshells. 
...
more neutron density into the high-momentum regime.
\begin{figure}[tb]
    \centering
...
(12.4\% for \caEight, 13.9\% for \caForty). However, a closer look at

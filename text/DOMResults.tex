...
\ref{Ca40EnergyDist}. Per our fit, even though the 0\sOne\ nucleons consitute
only about 8\% of the forty total nucleons in \caForty, they provide a significant
share of the binding
energy ([insert binding energy \% for protons and neutrons]). As the spectral
...
As with \caForty, we find that \oSix\ has a slightly negative neutron skin, [insert o16 neutron skin]
\femto\meter\.

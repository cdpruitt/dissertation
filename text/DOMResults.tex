...
\begin{table}[H]
    ...
    {\color{red}{\begin{tabular}{c c c c c}
                ...
                \midrule
                \oSix & 0\pOne & & 0\pOne & \\
                \oEight & 0\pOne & & 0\dFive & \\

                \caForty & 1\sOne & & 1\sOne & \\
                \caEight & 1\sOne & & 0\fSeven & \\

                \niEight & 0\fSeven & & [insert] & \\
                \niFour & 0\fSeven & & [insert] & \\

                \snTwelve & 0\gNine & & 0\gSeven & \\
                \snFour & 0\gNine & & [insert] & \\

                \pbEight & 2\sOne & & 1\fFive & \\
                \bottomrule
        \end{tabular}}
    }
...
\begin{table}[tb]
    ...
    \end{tabular}}}
\end{table}
The values we extract change little from A=16 to A=208, with perhaps a slight

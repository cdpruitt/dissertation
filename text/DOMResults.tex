...
theory (DFT) calculations \cite{Piekarewicz2012} and light enough for certain \textit{ab initio} 
...
scattering data available, \caAughtEight\ are ideal
...
\begin{figure}[tb]
    ...
    \caption[Proton \el\ on \caForty: DOM predictions and experimental data]
    {
...
\begin{figure}[tb]
    ...
    \caption[Neutron \el\ on \caForty: DOM predictions and experimental data]
    {
...
\begin{figure}[tb]
    ...
    \caption[Proton spectral functions in \caForty]
    {
        ...
        and former DOM treatments \cite{MahzoonPhDThesis}. The vertical lines at 20 MeV show the
        threshold used to calculate particle numbers in the \sOne\ and \dThree\ shells,
        per the discussion following Eq. \ref{ParticleNumber}.
    }
...
\begin{figure}[tb]
    ...
    \caption[Proton single-particle density distributions in \caForty]
    {
        ...
        depleted by 20-30\%. That the bound LJs are significantly
...
\begin{figure}[tb]
    ...
    \caption[Neutron momentum distribution in \caForty]
    {
...
\begin{figure}[tb]
    ...
    \caption[Volume integral of proton imaginary potential in \caForty]
    {
        ...
        there is some strength. The small -- but significant -- occupation at
...
for protons and neutrons in \caForty, respectively.
...
smaller \textit{ab initio} neutron skin size was forcibly applied to their fit, it disturbed the fit's
...
proton elastic scattering data sets and a complete neutron total cross section data set in hand, we did
...
likely deficient, as we would have discarded relevant physics. If the previous DOM treatment
was underconstrained, their result may be a consequence of overfitting. We
...
for $\chi$-EFT, shell model, and \textit{ab initio} approaches. A wealth of scattering and
...
\begin{figure}[tb]
    ...
    \caption[Charge density distribution of \oSix]
    {
...
for \oSix, \caAughtEight, \niEightFour, \snFour, and \pbEight) was unavailable. To
...
Of the isotopic systems studed in this treatment, \snTwelveFour\ was the least characterized by 
...
\begin{figure}[tb]
    ...
    \caption[Neutron momentum distribution in \snTwelve]
    {
...
shells, so it is sensible that the neutron skin we recover is nearly zero.
...
our \pbEight\ fit. As with \caEight, the proton high-momentum content is lower than the
...
\begin{figure}[tb]
    ...
    \caption[Neutron momentum distribution in \pbEight]
    {
...
light nuclei such as \cTwelve\ ($\approx10\%$ above 270 $\mega\electronvolt/\text{c}$).
Table \ref{HighMomentumContent} shows the
percentage of the proton and neutron densities with momentum
above 270 $\mega\electronvolt/\text{c}$ per our fits.
\begin{table}[tb]
    ...
    \end{tabular}
\end{table}
The values we extract are roughly constant for all nuclei at around 12-15\% for protons and
...
the proton Fermi energy drops considerably,
...
neutrons that we extract can only be taken qualitatively.

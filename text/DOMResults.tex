...
\begin{table}[tb]
    ...
    {\color{red}{\begin{tabular}{c c c c c c c c c c c c}
                ...
                \midrule
                $\pi_{occ}$ & 3.47 & 3.68 & 1.82 & 5.35 & 3.34 & 0.42 & 0.22 & 0.25 & 0.16
                & 1.13 & 19.84\\
                $\nu_{occ}$ & 3.48 & 3.67 & 1.82 & 5.34 & 3.34 & 0.42 & 0.22 & 0.25 & 0.16
                & 1.11 & 19.80\\
                \bottomrule
...
As was seen in \oSix\ and \caForty, it is sensible that in symmetric systems,
...
\begin{table}[H]
    ...
    {\color{red}{\begin{tabular}{c c c c}
                \toprule
                Isotope & proton $r_{rms}$ [\femto\meter] & neutron $r_{rms}$
                [\femto\meter] & $\Delta_{rms}$ [\femto\meter]\\
                \midrule
                \oSix & 2.676 & 2.653 & -0.022\\
                \oEight & 2.677  & 2.874 & 0.197\\

                \caForty & 3.462 & 3.406 & -0.056\\
                \caEight & 3.488 & 3.709 & 0.221\\

                \niEight & 3.727 & 3.695 & -0.032\\
                \niFour & 3.831 & 3.869 & 0.038\\

                \snTwelve & 4.539 & 4.557 & 0.018\\
                \snFour & 4.663 & 4.778 & 0.115\\

                \pbEight & 5.480 & 5.680 & 0.200\\
                \bottomrule
        \end{tabular}}
    }
    \caption[Neutron skins extracted from DOM analysis. All values are after
        rounding, so the neutron skin reported in the last column may not 
    exactly match the difference in proton and neutron rms radii listed.]
    {
...
\begin{table}[tb]
    ...
    {\color{red}{\begin{tabular}{c c c c}
                ...
                \caForty & 15.8 & 16.5 & 0.96\\
                \caEight & 11.8 & 12.6 & 0.93\\

                \niEight & 14.0 & 17.0 & 0.82\\
                \niFour & 16.6 & 14.2 & 1.17\\

                \snTwelve & 16.1 & 18.1 & 0.89\\
                \snFour & 15.0 & 16.5 & 0.91\\

                \pbEight & 15.3 & 17.6 & 0.87\\
                \bottomrule
    \end{tabular}}}
\end{table}
The values we extract are similar from A=16 to A=208, with perhaps a slight
...
short-range correlations for these nucleons. [insert fix as necessary] All of these expectations are borne

...
\newglossaryentry{inverse kinematics}
{
    ...
    description={An experimental approach where a static target is made from
        the typical scattering body (e.g., protons or $\alpha$-particles) and
        the nucleus under study (e.g., $^{14}$O) is bombarded as a beam into the
        target. In this way, reactions can be studied on unstable nuclei that

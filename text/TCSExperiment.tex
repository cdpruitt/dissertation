...
\begin{table}[tb]
    \caption[Selected results from a literature study of isotopically-
        ...
        {Selected results from a literature search for isotopically-
        resolved \tot\ data using the EXFOR database \cite{EXFORDatabase}.
        For the heaviest and lightest stable nuclides in each closed shell in Z, all
        datasets falling at least partially within 1-500 \mega\electronvolt\ are shown. For elements
    ...
    \begin{center}
        \begin{tabular}{ c c c c }
            \hline
            Isotope & Nat. Abund. [\%] & Energies [\mega\electronvolt] & Reference \\
            \hline

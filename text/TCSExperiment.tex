...
Fig. \ref{TOFDetectorDisassembled} shows a time-of-flight detector used in one
of our
...
\begin{figure}
    \includegraphics[scale=0.6]{figures/TimeOfFlightCAD.png}
    \caption{Cutaway figure showing light-tight fitting of time-of-flight detector.}
    \label{TOFCAD}
\end{figure}
...
Signals from all detectors and the target changer were relayed to an 8-channel, 500-MHz CAEN 
DT-5730

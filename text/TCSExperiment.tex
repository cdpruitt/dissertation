...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{figures/DownstreamFromMonitor.jpg}
    \caption[Sample changer, veto detector, and time-of-flight detector]
    {
        Sample changer (in foreground at left) and veto and time-of-flight detectors (in
        background at right), installed in the 15R beamline
    }

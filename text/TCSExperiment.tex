...
Fig. \ref{TOFDetectorDisassembled} shows the time-of-flight detector used in our
...
and Sn samples, to match the $\frac{3}{4}$"-diameter wells of the target changer \ref{RhodiumSample.jpg}.
...
simulations, the beam was collimated to 0.200 inches at the entrance to the
...
\ref{VetoAndTOFDetectors}. Fig. \ref{BeamlineUpstrea} shows the entire
...
precise alignment, a 2\inch aluminum cylinder with a $\frac{1}{16}$\inch axial hole was placed
in the first position of the target changer and a radiographic film placed
...
Signals from all detectors and the target changer were relayed to an 8-channel, 500-MHz CAEN DT-5730

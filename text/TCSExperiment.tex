...
energy determination is neutron time-of-flight.
...
BC-800 lightguides with RTV rubberized adhesive. These components were encased
...
Phototube signals and high voltage are supplied by a phototube base attached to the back of each
...
3.5 grams were from semi-permanent loan from the group of Lee Bernstein from LLNL
...
\ref{VetoAndTOFDetectors}. The monitor detector and veto detector, not pictured
disassembled, follow similar principles of construction as the time-of-flight
detector, though only have one phototube each. The monitor and
veto detectors each had scintillator thicknesses of $\frac{1}{4}$ inch. Fig. \ref{BeamlineUpstream} 

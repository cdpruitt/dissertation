...
Neutron scattering is a direct, Coulomb-independent tool for probing the nuclear
...
By scattering secondary radioactive beams off hydrogen targets in \gls{inverse
...
\begin{figure}[tb]
    ...
    {A TOF detector, partially assembled, with pencil for scale.
...
left side of the CAD cutaway in Fig. \ref{TOFCAD}) were custom-made to apply slight
...
was also prepared for each element to benchmark our results against already-existing
literature neutron \tot\ data on natural samples. During the experiment, the samples were inserted
...
extremely-well-known neutron \tot\ on hydrogen could be subtracted to yield the O \tot\ values.
This technique was also used by \cite{Vaughn1965, Salisbury1965}; cf. 
...
Goodfellow Corp. These were corralled inside a
...
September 2017). At WNR, broad-spectrum neutrons up to 700 \mega\electronvolt\
are generated by impinging an
800-\mega\electronvolt\ proton beam onto a water-cooled, 7.5-\centi\meter-long
tungsten target (see Fig. \ref{ExperimentalApparatus}). A 
permanent magnet deflects all charged particles from the beam path, 
allowing only neutrons and $\gamma$ rays to reach our samples. The neutron flux can be
...
experimental vault using steel donuts with a total thickness of 24 inches.
To reduce (but not eliminate) the $\gamma$-ray component of the beam,
a $\frac{1}{2}$-inch-thick plug of Hevimet (90\% W, 6\% 
...
\begin{figure}[tb]
    ...
    \caption[Pulse structure of the neutron beam at the WNR facility]
    {
...
micropulse, increasing the digitizer-dead probability for the highest-energy
...
Signals from all detectors and the sample changer were relayed to an 8-channel,
14-bit, 500-MHz CAEN 
DT-5730

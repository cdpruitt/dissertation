\documentclass[12pt,twoside]{book} %twosided is nice requires (sometimes) introduces blank pagestyle, which is cool because it looks nice and lets me make fancy headers
...
\def\thickhrulefill{\leavevmode \leaders \hrule height 0.7ex \hfill \kern 0pt}

% Manually define chapter title formatting

...
\newcommand{\el}{\ensuremath{\frac{d\sigma_{el}}{d\Omega}}\,}

% nuclides
\newcommand{\cNat}{\ensuremath{^{nat}}C}
...
\newcommand{\snNat}{\ensuremath{^{nat}}Sn}

\newcommand{\pbEight}{\ensuremath{^{208}}Pb}
\newcommand{\pbNat}{\ensuremath{^{nat}}Pb}
...
\begin{appendices}
  ...
  %Reformat chapter titles so that they say appendix in the appendices
    ...
    \chapter{Experimental Data Used to Constrain DOM Potential}
    ...
    \chapter{Visualization of DOM Potentials and Comparison to Experiment}
